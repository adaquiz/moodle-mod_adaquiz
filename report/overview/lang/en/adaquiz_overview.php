...
/**
 * Strings for component 'adaquiz_overview', language 'en'.
 *
...
$string['nogradepermission'] = 'You don\'t have permission to grade this adaptive quiz.';
$string['onlyoneattemptallowed'] = 'Only one attempt per user allowed on this adaptive quiz.';
$string['optallattempts'] = 'all attempts';
$string['optallstudents'] = 'all {$a} who have or have not attempted the adaptive quiz';
$string['optattemptsonly'] = '{$a} who have attempted the adaptive quiz';
$string['optnoattemptsonly'] = '{$a} who have not attempted the adaptive quiz';
