...
/**
 * The mod_adaquiz attempt reviewed event.
 *
 * @package   mod_adaquiz
...
/**
 * The mod_adaquiz attempt reviewed event class.
 *
...
class attempt_reviewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptreviewed', 'mod_adaquiz');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'adaquiz', 'review', 'review.php?attempt=' . $this->objectid,
