YUI.add('moodle-mod_adaquiz-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_adaquiz-questionchooser'
});

M.mod_adaquiz = M.mod_adaquiz || {};
M.mod_adaquiz.init_questionchooser = function() {
    M.mod_adaquiz.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_adaquiz.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_adaquiz-util", "querystring-parse"]});
