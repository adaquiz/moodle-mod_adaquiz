YUI.add('moodle-mod_adaquiz-adaquizquestionbank', function (Y, NAME) {
...
/**
 * Add questions from question bank functionality for a popup in adaptive quiz editing page.
 *
 * @package   mod_adaquiz
...
Y.extend(POPUP, Y.Base, {
    ...
    load_content : function(queryString) {
        Y.log('Starting load.', 'debug', 'moodle-mod_adaquiz-adaquizquestionbank');
        ...
        Y.log('Load request sent.', 'debug', 'moodle-mod_adaquiz-adaquizquestionbank');
    },
    ...
    load_done: function(transactionid, response) {
        ...
        Y.log('Load completed.', 'debug', 'moodle-mod_adaquiz-adaquizquestionbank');
    ...
    load_failed: function() {
        Y.log('Load failed.', 'debug', 'moodle-mod_adaquiz-adaquizquestionbank');
    },

    link_clicked: function(e) {
        // Add question to adaptive quiz. mofify the URL, then let it work as normal.
...
M.mod_adaquiz.adaquizquestionbank = M.mod_adaquiz.adaquizquestionbank || {};
M.mod_adaquiz.adaquizquestionbank.init = function() {
    return new POPUP();
};
