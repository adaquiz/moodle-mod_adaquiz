YUI.add('moodle-mod_adaquiz-dragdrop', function (Y, NAME) {
...
M.mod_adaquiz.init_resource_dragdrop = function(params) {
    ...
    "requires": [
        ...
        "moodle-mod_adaquiz-adaquizbase",
        "moodle-mod_adaquiz-util-base",
        "moodle-mod_adaquiz-util-page",
        "moodle-mod_adaquiz-util-slot",
        "moodle-course-util"
    ]
});
