...
M.mod_adaquiz.timer = {
    ...
    init: function(Y, timeleft) {
        ...
        M.mod_adaquiz.timer.endtime = new Date().getTime() + timeleft*1000;
...
M.mod_adaquiz.secure_window = {
    init: function(Y) {
        ...
        Y.delegate('mousedown',   M.mod_adaquiz.secure_window.prevent_mouse, document, '*');
        Y.delegate('mouseup',     M.mod_adaquiz.secure_window.prevent_mouse, document, '*');
        Y.delegate('dragstart',   M.mod_adaquiz.secure_window.prevent, document, '*');
        Y.delegate('selectstart', M.mod_adaquiz.secure_window.prevent, document, '*');
        ...
        M.mod_adaquiz.secure_window.clear_status;
    ...
    clear_status: function() {
        window.status = '';
        setTimeout(M.mod_adaquiz.secure_window.clear_status, 10);
    },
