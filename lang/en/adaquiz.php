...
/**
 * String components for mod_adaquiz package, lang 'en'.
 *
 * @package    adaquiz
...
$string['accessnoticesheader'] = 'You can preview this adaptive quiz, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have adaptive quizzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the adaptive quiz. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the adaptive quiz. This means that different students are likely to get a different selection of questions, and when an adaptive quiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
$string['addarandomselectedquestion'] = 'Add a random selected question ...';
$string['addcase'] = 'Add case';
$string['adddescriptionlabel'] = 'Add a description item';
$string['addingquestion'] = 'Adding a question';
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any adaptive quiz in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your adaptive quiz over on the other side of this page.</p>';
...
$string['addquestionstoquiz'] = 'Add questions to current adaptive quiz';
...
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the adpative quiz. This means that different students are likely to get a different selection of questions, and when an adaptive quiz allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addrandomquestiontoquiz'] = 'Add a random question to adaptive quiz {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoquiz'] = 'Add selected questions to the adaptive quiz';
$string['addselectedtoquiz'] = 'Add selected to adaptive quiz';
$string['addtoquiz'] = 'Add to adaptive quiz';
...
$string['attempterror'] = 'You are not allowed to attempt this adaptive quiz at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptquiznow'] = 'Attempt adaptive quiz now';
$string['attempts'] = 'Attempts';
$string['attemptsallowed'] = 'Attempts allowed';
$string['attemptsdeleted'] = 'Adaptive quiz attempts deleted';
...
$string['autosaveperiod_desc'] = 'Students\' responses can be saved automatically every few minutes during adaptive quiz attempts. This involves a trade-off: saving the responses increases the server load, but reduces the chance that students lose their work.';
$string['back'] = 'Back to preview question';
$string['backtocourse'] = 'Back to the course';
$string['backtoquestionlist'] = 'Back to question list';
$string['backtoquiz'] = 'Back to adaptive quiz editing';
$string['basicideasofquiz'] = 'The basic ideas of adaptive quiz-making';
...
* The adaptive quiz will only start if the student has a JavaScript-enabled web-browser
* The adaptive quiz appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this adaptive quiz has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the adaptive quiz';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this adaptive quiz. The adaptive quiz is set to be graded out of {$a->grade}, but none of the questions in the adaptive quiz have a grade. This can be fixed on the \'Edit adaptive quiz\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this adaptive quiz. The adaptive quiz definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this adaptive quiz. The adaptive quiz has not been set up yet. No questions have been added.';
...
$string['closebeforeopen'] = 'Could not update the adaptive quiz. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark adaptive quiz complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the adaptive quiz.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the adaptive quiz.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the adaptive quiz.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a adaptive quiz after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the adaptive quiz.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new adaptive quiz. You can also configure which adaptive quiz settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the adaptive quiz grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the adaptive quiz page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the adaptive quiz editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during adaptive quiz attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the adaptive quiz.';
$string['configrequiresubnet'] = 'Students can only attempt the adaptive quiz from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a adaptive quiz attempt or look at the adaptive quiz reports.';
$string['configshowblocks'] = 'Show blocks during adaptive quiz attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflequestions'] = 'If you enable this option, then the order of questions in  the adaptive quiz will be randomly shuffled each time a student attempts the adaptive quiz.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this adaptive quiz, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for adaptive quizzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for adaptive quizzes in seconds. 0 mean no time limit.';
...
$string['confirmstartattempttimelimit'] = 'This adaptive quiz has a time limit and is limited to {$a} attempt(s). You are about to start a new attempt.  Do you wish to proceed?';
$string['confirmstarttimelimit'] = 'The adaptive quiz has a time limit. Are you sure that you wish to start?';
...
$string['countdownfinished'] = 'The adaptive quiz is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The adaptive quiz will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to adaptive quiz';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the adaptive quiz.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the adaptive quiz a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the adaptive quiz a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/adaquiz folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new adaptive quiz attempt will contain the results of the previous attempt. This allows an adaptive quiz to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingnode']= 'Editing Node';
$string['editingquestion'] = 'Editing a question';
$string['editingquiz'] = 'Editing adaptive quiz';
$string['editingquiz_help'] = 'When creating an adaptive quiz, the main concepts are:

* The adaptive quiz, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the adaptive quiz and different students can get different questions';
$string['editingquiz_link'] = 'mod/adaquiz/edit';
$string['editingquizx'] = 'Editing adaptive quiz: {$a}';
$string['editjump'] = 'Edit jump';
$string['editnode'] = '';
$string['editnode_help'] = '<h2>Node options</h2>';
...
$string['editquiz'] = 'Edit adaptive quiz';
$string['editquizquestions'] = 'Edit adaptive quiz questions';
...
$string['eventattemptdeleted'] = 'Adaptive uiz attempt deleted';
$string['eventattemptpreviewstarted'] = 'Adaptive quiz attempt preview started';
$string['eventattemptreviewed'] = 'Adaptive quiz attempt reviewed';
$string['eventattemptsummaryviewed'] = 'Adaptive quiz attempt summary viewed';
$string['eventattemptviewed'] = 'Adaptive quiz attempt viewed';
$string['eventeditpageviewed'] = 'Adaptive quiz edit page viewed';
$string['eventoverridecreated'] = 'Adaptive quiz override created';
$string['eventoverridedeleted'] = 'Adaptive quiz override deleted';
$string['eventoverrideupdated'] = 'Adaptive quiz override updated';
$string['eventquestionmanuallygraded'] = 'Question manually graded';
$string['eventquizattemptabandoned'] = 'Adaptive quiz attempt abandoned';
$string['eventquizattempttimelimitexceeded'] = 'Adaptive quiz attempt time limit exceeded';
$string['eventquizattemptstarted'] = 'Adaptive quiz attempt started';
$string['eventquizattemptsubmitted'] = 'Adaptive quiz attempt submitted';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the adaptive quiz. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the adaptive quiz when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this many seconds after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the adaptive quiz. You have to make a trade-off based on how much you trust the performance of your server during adaptive quizzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final adaptive quiz grade:

* Highest grade of all attempts
* Average (mean) grade of all attempts
* First attempt (all other attempts are ignored)
* Last attempt (all other attempts are ignored)';
$string['gradesdeleted'] = 'Adaptive quiz grades deleted';
...
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in an adaptive quiz.';
$string['iflastquestiongrade'] = 'If last grade';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the adaptive quiz';
...
$string['invalidquizid'] = 'Invalid adaptive quiz ID';
...
$string['jump'] = 'Jump';
$string['jumptoquestion'] = 'Jump to other question:';
$string['last_grade'] = 'Last grade';
...
$string['letstudentdecidejump'] = 'Let student decide jump';
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in adaptive quiz';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your adaptive quiz attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own adaptive quiz submissions';
$string['messageprovider:submission'] = 'Notification of adaptive quiz submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The adaptive quiz activity enables a teacher to create adaptive quizzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the adaptive quiz to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/adaquiz/view';
$string['modulenameplural'] = 'Adaptive Quizzes';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the adaptive quiz in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the adaptive quiz';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer adaptive quizzes it makes sense to stretch the adaptive quiz over several pages by limiting the number of questions per page. When adding questions to the adaptive quiz, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this adaptive quiz';
...
$string['nodeoptions'] = 'Node options';
$string['noessayquestionsfound'] = 'No manually graded questions found';
$string['nogradewarning'] = 'This adaptive quiz is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the adaptive quiz settings.';
...
$string['noquestionsinquiz'] = 'There are no questions in this adaptive quiz.';
...
$string['noreview'] = 'You are not allowed to review this adaptive quiz';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this adaptive quiz until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This adaptive quiz is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the adaptive quiz module. As a work around, set a time limit for the whole adaptive quiz. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this adaptive quiz';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this adaptive quiz';
$string['numberabbr'] = '#';
...
$string['openclosedatesupdated'] = 'Adaptive quiz open and close dates updated';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after an adaptive quiz has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the adaptive quiz before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their adaptive quiz attempt before time expires. If the student is actively working on the adaptive quiz at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/adaquiz/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this adaptive quiz to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['pageshort'] = 'P';
$string['page-mod-adaquiz-x'] = 'Any adaptive quiz module page';
$string['page-mod-adaquiz-attempt'] = 'Attempt adaptive quiz page';
$string['page-mod-adaquiz-edit'] = 'Edit adaptive quiz page';
$string['page-mod-adaquiz-report'] = 'Any adaptive quiz report page';
$string['page-mod-adaquiz-review'] = 'Review adaptive quiz attempt page';
$string['page-mod-adaquiz-summary'] = 'Adaptive quiz attempt summary page';
$string['page-mod-adaquiz-view'] = 'Adaptive quiz information page';
...
$string['popup'] = 'Show adaptive quiz in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the adaptive quiz in a secure window. Please turn off your popup blocker. Thank you.';
...
$string['previewquiznow'] = 'Preview adaptive quiz now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->quiznames}<br />The question will not be deleted from these adaptive quizzes but only from the category list.';
...
$string['questionsinthisquiz'] = 'Questions in this adaptive quiz';
...
$string['quiz:addinstance'] = 'Add a new adaptive quiz';
$string['quiz:attempt'] = 'Attempt adaptive quizzes';
$string['quizavailable'] = 'The adaptive quiz is available until: {$a}';
$string['quizclose'] = 'Close the adaptive quiz';
$string['quizclosed'] = 'This adaptive quiz closed on {$a}';
$string['quizcloses'] = 'Adaptive quiz closes';
$string['quizcloseson'] = 'This adaptive quiz will close at {$a}';
$string['quiz:deleteattempts'] = 'Delete adaptive quiz attempts';
...
$string['quiz:grade'] = 'Grade adaptive quizzes manually';
$string['quiz:ignoretimelimits'] = 'Ignores time limit on adaptive quizzes';
$string['quizisclosed'] = 'This adaptive quiz is closed';
$string['quizisopen'] = 'This adaptive quiz is open';
$string['quizisclosedwillopen'] = 'Adaptive quiz closed (opens {$a})';
$string['quizisopenwillclose'] = 'Adaptive quiz open (closes {$a})';
$string['quiz:manage'] = 'Manage adaptive quizzes';
$string['quiz:manageoverrides'] = 'Manage adaptive quiz overrides';
$string['quiznavigation'] = 'Adaptive quiz navigation';
$string['quizopen'] = 'Open the adaptive quiz';
...
$string['quizopenclose_link'] = 'mod/adaquiz/timing';
$string['quizopened'] = 'This adaptive quiz is open.';
$string['quizopenedon'] = 'This adaptive quiz opened at {$a}';
$string['quizopens'] = 'Adaptive quiz opens';
$string['quizopenwillclose'] = 'This adaptive quiz is open, will close on {$a} at';
$string['quizordernotrandom'] = 'Order of adaptive quiz not shuffled';
$string['quizorderrandom'] = '* Order of adaptive quiz is shuffled';
$string['quiz:preview'] = 'Preview adaptive quizzes';
$string['quiz:regrade'] = 'Regrade adaptive quiz attempts';
$string['quiz:reviewmyattempts'] = 'Review your own attempts';
$string['quizsettings'] = 'Adaptive quiz settings';
$string['quiz:view'] = 'View adaptive quiz information';
$string['quiz:viewreports'] = 'View adaptive quiz reports';
$string['quiztimer'] = 'Adaptive uiz Timer';
$string['quizwillopen'] = 'This adaptive quiz will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole adaptive quiz to be graded.  Are you sure you want to continue?';
$string['reattemptquiz'] = 'Re-attempt adaptive quiz';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this adaptive quiz';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingquiz'] = 'Regrading adaptive quiz "{$a}"';
$string['remove'] = 'Remove';
$string['removeallquizattempts'] = 'Delete all adaptive quiz attempts';
...
$string['reportusersall'] = 'all users who have attempted the adaptive quiz';
$string['reportuserswith'] = 'enrolled users who have attempted the adaptive quiz';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the adaptive quiz';
$string['reportuserswithout'] = 'enrolled users who have not attempted the adaptive quiz';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the adaptive quiz.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Adaptive quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) quiz, to ensure that only people in a certain location can access the quiz.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to adaptive quiz defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after adaptive quiz is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while adaptive quiz is open';
$string['reviewclosed'] = 'After the adaptive quiz is closed';
...
$string['reviewopen'] = 'Later, while the adaptive quiz is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review an adaptive quiz attempt or look at the adaptive quiz reports.
...
**Later, while the adaptive quiz is still open** settings apply after this, and before the adaptive quiz close date.

**After the adaptive quiz is closed** settings apply after the adaptive quiz close date has passed. If the adaptive quiz does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current adaptive quiz attempt.';
...
$string['savequiz'] = 'Save this whole adaptive quiz';
...
$string['showblocks'] = 'Show blocks during adaptive quiz attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during adaptive quiz attempts';
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the adaptive quiz, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonquiz'] = 'Specified question is not on the specified adaptive quiz';
...
$string['subneterror'] = 'Sorry, this adaptive quiz has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this adaptive quiz.';
$string['subnetnotice'] = 'This adaptive quiz has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the adaptive quiz.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the adaptive quiz since you have not passed the time delay before attempting another adaptive quiz';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial adaptive quiz page and a countdown timer is displayed in the adaptive quiz navigation block.';
$string['timelimit_link'] = 'mod/adaquiz/timing';
$string['timelimitexeeded'] = 'Sorry! Adaptive Quiz time limit exceeded!';
...
$string['type'] = 'Type';
$string['unconditional'] = 'Unconditional';
...
$string['updatesettings'] = 'Update adaptive quiz settings';
...
$string['upgradesure'] = '<div>In particular the adaptive quiz module will perform an extensive change of the adaptive quiz tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingquizattempts'] = 'Upgrading adaptive quiz attempts: adaptive quiz {$a->done}/{$a->outof} (Adaptive quiz id {$a->info})';
$string['upgradingveryoldquizattempts'] = 'Upgrading very old adaptive quiz attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this adaptive quiz';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} adaptive quiz attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this adaptive quiz';
$string['yourfinalgradeis'] = 'Your final grade for this adaptive quiz is {$a}.';
