...
$string['adaquiz:addinstance'] = 'Add a new quiz';
$string['adaquiz:attempt'] = 'Attempt quizzes';
$string['adaquiz:deleteattempts'] = 'Delete quiz attempts';
$string['adaquiz:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['adaquiz:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['adaquiz:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['adaquiz:grade'] = 'Grade quizzes manually';
$string['adaquiz:ignoretimelimits'] = 'Ignores time limit on quizzes';
$string['adaquiz:manage'] = 'Manage quizzes';
$string['adaquiz:manageoverrides'] = 'Manage quiz overrides';
$string['adaquiz:preview'] = 'Preview quizzes';
$string['adaquiz:regrade'] = 'Regrade quiz attempts';
$string['adaquiz:reviewmyattempts'] = 'Review your own attempts';
$string['adaquiz:view'] = 'View quiz information';
$string['adaquiz:viewreports'] = 'View quiz reports';
...
$string['addrandom'] = 'Add random question';
...
$string['addtoadaquiz'] = 'Add to quiz';
...
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this quiz. The quiz is set to be graded out of {$a->grade}, but none of the questions in the quiz have a grade. This can be fixed on the \'Edit adaptive quiz\' page.';
...
$string['canteditduetoattempts'] = 'This adaptive quiz has attempts. It cannot be edited unless the attempts are deleted.';
$string['casecantbedeleted'] = 'There must be always an unconditional jump case.';
...
$string['commonrandomseed'] = 'Use common random seed';
...
$string['continuepreview'] = 'Continue preview';
...
<b>Use common random seed:</b> This option is only available in WIRIS quizzes questions. If checked, the random seed used in the WIRIS quizzes algorithm will be the same for all questions in a single attempt which have this option checked.

<b>Let student decide jump:</b> If checked, then the student will be able to choose the next node to visit from the list of accessible nodes.

<h2>Jump</h2>

The list of jump cases. Every jump case has a condition which evaluates to true or false. Once the student has answered a question, the jump case conditions are evaluated sequentially from the first to the last. The first jump case that evaluates to true determines the next node to visit. So, if the first jump case has an unconditional condition, it will always be the choosen jump. There must be always an unconditional jump case in the last position of the list.

<h2>Add case</h2>

Adds a new jump case. There are several types of jump cases. Every jump case has a few configurable options:

<b>Name:</b> The name is used to identify the jump case. In particular, when the student can decide the jump, these names will be the shown labels.

<b>Condition:</b> The unconditional jump cases don\'t have configurable condition. When a jump case has configurable condition, its values will depend on the type.

<b>Go to:</b> The node to go if the condition is satisfied. It must be one of the nodes in this Adaptive Quiz and can be the same node itself.';
...
$string['end'] = 'End';
$string['endadaquiz'] = 'End of adaptive quiz';
...
$string['gradedappempthighlighted'] = 'The one attempt for each user that is graded is highlighted';
...
$string['helprichtext'] = 'Help richtext - changeme';
$string['helprichtext_help'] = 'Help richtext - help. changeme';
...
$string['modulename_help'] = 'The Adaptative Quiz activity enables a teacher to arrange questions in dynamic pathways that depend on the students answers. The result is a quiz that adapts itself to the student performance. Technically speaking, it\'s a directed graph where the nodes are questions, and the edges are jumps triggered by grade ranges.

The student answers a question, that is marked automatically, and then the grade determines the next question.
Usually, if the answer was wrong the next question will be easier, and if the answer was right the next question will be harder, and so on.

Apart from that, it\'s like the common Moodle quiz activity.
The teacher can use any type of question, and configure the usual quiz settings about hints and feedback.';
...
$string['noadaquizzes'] = 'There are no Adaptive Quizzes in this course';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'There aren\'t attempts yet.';
...
$string['nodes'] = 'Nodes';
$string['nodesinthisadaquiz'] = 'Nodes in this adaptive quiz';
...
$string['none'] = 'None';
$string['nonodes'] = 'No nodes have been added yet';
$string['nonodesonquiz'] = 'No nodes have been added yet';
...
$string['outofamaximumof'] = 'out of a maximum of';
...
$string['page-mod-quiz-edit'] = 'Edit adaptive quiz page';
...
$string['resetadaquizall'] = 'Reset all adaptative quizzes';
...
$string['reviewafterquestion']='Review after question attempt';
$string['reviewafterquiz']='Review after quiz attempt';
...
$string['reviewofattempt'] = 'Review of attempt';
...
$string['timefinished'] = 'Time finished';
