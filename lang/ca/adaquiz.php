...
$string['modulenameplural'] = 'Qüestionaris adaptatius';
$string['introduction'] = 'Introducció';
$string['info'] = 'Info';
$string['results'] = 'Resultats';
$string['preview'] = 'Previsualitzar';
$string['nodesinthisadaquiz'] = 'Nodes en aquest qüestionari adaptatiu';
$string['addtoadaquiz'] = 'Afegir al qüestionari';
$string['nonodes'] = 'Encara no s\'han afegit nodes';
...
$string['end'] = 'Fi';
$string['editingnode']= 'Editant node';
$string['editnode'] = '';
$string['editnode_help'] = '<h2>Opcions de node</h2>

<b>Usa la llavor aleatória comuna:</b> Aquesta opció només és disponible per a preguntes de WIRIS quizzes. Si es selecciona, la llavor aleatòria que utilitza l\'algorisme de la pregunta WIRIS quizzes será la mateixa per a totes les preguntes en un intent que tinguin aquesta opció seleccionada.

<b>Permet a l\'estudiant decidir el salt:</b> Si es selecciona, l\'estudiant podrà escollir el següent node d\'entre la llista de nodes accessibles.

<h2>Salt</h2>

La llista dels casos de salt. Cada cas de salt té una condició que avalua a cert o fals. Després de que l\'estudiant respongui a una pregunta, les condicions dels casos de salt són avaluades seqüencialment començant pel primer. El primer cas de salt que avalui a cert determinarà el següent node a visitar. Així, si el primer cas de salt és incondicional, sempre serà l\'escollit. Sempre ha d\'haver-hi un cas de salt incondicional a la última posició de la llista.

<h2>Afegir cas</h2>

Crea un nou cas de salt. Hi ha diferents tipus de casos de salt. Cada cas de salt té algunes opcions configurables:

<b>Nom:</b> El nom serveix per identificar el cas de salt. En particular, quan l\'estudiant pot decidir el salt, aquests noms seran els que se li mostran per a que esculli.

<b>Condició:</b> Els casos de salt incondicionals no tenen condició configurable. En els altres casos, els valors depenen del tipus de cas.

<b>Anar a:</b> El següent node on anar si la condició es satisfà. Ha de ser un dels nodes en aquest Qüestionari Adaptatiu i pot ser el mateix node.';
$string['commonrandomseed'] = 'Usa la llavor aleatòria comuna';
$string['endadaquiz'] = 'Fi del qüestionari adaptatiu';
$string['gotonode'] = 'Anar al node';
$string['iflastquestiongrade'] = 'Si la última nota';
$string['nodeoptions'] = 'Opcions de node';
$string['addcase'] = 'Afegir cas';
$string['finish_adaquiz'] = 'Finalitzar';
$string['unconditional'] = 'Incondicional';
$string['last_grade'] = 'Última nota';
$string['order'] = 'Ordre';
$string['condition'] = 'Condició';
$string['goto']='Anar a';
$string['always'] = 'Sempre';
$string['letstudentdecidejump'] = 'Permet a l\'estudiant decidir el salt';
$string['noadaquizzes'] = 'No hi ha Qüestionaris adaptatius en aquest curs';
$string['attempts'] = 'Intents';
$string['attemptnow'] = 'Intenta ara';
$string['reattempt'] = 'Re-intenta';
$string['continueattempt'] = 'Continua intent';
$string['continuepreview'] = 'Continua previsualització';
$string['attempt'] = 'Intent';
$string['completed'] = 'Completat';
$string['notyetcompleted'] = 'No completat';
$string['finish'] = 'Finalitzar';
$string['attemptfinished'] = 'Intent finalitzat';
$string['canteditduetoattempts'] = 'Aquest qüestionari adaptatiu té intents. No pot ser editat a no ser que els intents siguin esborrats.';
$string['nodes'] = 'Nodes';
$string['editjump'] = 'Editar salt';
$string['casecantbedeleted'] = 'Sempre ha d\'haver-hi un un case de salt incondicional.';
$string['timestarted'] = 'Moment iniciat';
$string['timefinished'] = 'Moment finalitzat';
$string['timetaken'] = 'Temps transcorregut';
$string['grade'] = 'Nota';
$string['unfinished'] = 'No finalitzat';
$string['outofamaximumof'] = 'sobre';
$string['tonode'] = 'cap al node';
$string['reviewofattempt'] = 'Revisió de l\'intent';
$string['reviewofpreview'] = 'Revisió de la previsualització';
$string['noattempts'] = 'Encara no hi ha intents.';
$string['jumptoquestion'] = 'Salta a una altra pregunta:';
$string['maximumgrade'] = 'Nota màxima:';
$string['savechanges'] = 'Guarda els canvis';
$string['addrandom'] = 'Afegeix pregunta aleatòria';
$string['startagain'] = 'Torna a començar';
$string['finishreview'] = 'Finalitza revisió';
$string['gradedappempthighlighted'] = 'L\'intent avaluat de cada usuari és el ressaltat';
$string['resetadaquizall'] = 'Reinicia tots els qüestionaris adaptatius';
$string['review'] = 'Revisió';
$string['useranswer'] = 'Resposta de l\'estudiant';
$string['correctanswer']='Resposta correcta';
$string['feedback']='Retroacció';
$string['score']='Puntuació';
$string['reviewafterquestion']='Revisió després d\'una pregunta';
$string['reviewafterquiz']='Revisió després del qüestionari';
...
habitualment, si es la resposta ha estat incorrecta la següent pregunta serà més fàcil, i si la resposta ha estat correcta la següent pregunta serà més difícil, i així successivament.
