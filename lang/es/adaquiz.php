...
$string['addcase'] = 'Añadir caso';
$string['addtoadaquiz'] = 'Añadir al cuestionario';
$string['addrandom'] = 'Añadir pregunta aleatoria';
$string['always'] = 'Siempre';
$string['attempt'] = 'Intento';
$string['attemptfinished'] = 'Intento finalizado';
$string['attemptnow'] = 'Intenta ahora';
$string['attempts'] = 'Intentos';
$string['canteditduetoattempts'] = 'Este Cuestionario adaptativo tiene intentos. No puede ser editado a no ser que se borren los intentos.';
$string['casecantbedeleted'] = 'Simepre tiene que haber un caso de salto incondicional.';
$string['commonrandomseed'] = 'Utiliza la semilla aleatoria común';
$string['completed'] = 'Completado';
$string['condition'] = 'Condición';
$string['continueattempt'] = 'Continua intento';
$string['continuepreview'] = 'Continua previsualización';
$string['correctanswer']='Respuesta correcta';
$string['editjump'] = 'Editar salto';
$string['editingnode']= 'Editando Nodo';
$string['editingquiz'] = 'Editando Cuestionario adaptativo';
$string['editingquizx'] = 'Editando Cuestionario adaptativo: {$a}';
$string['editnode'] = '';
$string['editnode_help'] = '<h2>Opciones de nodo</h2>

<b>Usa la semilla aleatoria común:</b> Esta opción sólo está disponible para preguntas de WIRIS quizzes. Si se selecciona, la semilla aleatoria que utiliza el algoritmo de la pregunta WIRIS quizzes será la misma para todas las preguntas en un intento de que tengan esta opción seleccionada.
<b>Permite al estudiante decidir el salto:</b> Si se selecciona, el estudiante podrá escoger el siguiente nodo de entre la lista de nodos accesibles.

<h2>Salto</h2>

La lista de los casos de salto. Cada caso de salto tiene una condición que evalúa a cierto o falso. Después de que el estudiante responda a una pregunta, las condiciones de los casos de salto son evaluadas secuencialmente comenzando por el primero. El primer caso de salto que evalúe a cierto determinará el siguiente nodo a visitar. Así, si el primer caso de salto es incondicional, siempre será el elegido. Siempre ha de haber un caso de salto incondicional a la última posición de la lista.

<h2>Añadir caso</h2>

Crea un nuevo caso de salto. Hay diferentes tipos de casos de salto. Cada caso de salto tiene algunas opciones configurables:

<b>Nombre:</b> El nombre sirve para identificar el caso de salto. En particular, cuando el estudiante puede decidir el salto, estos nombres serán los que se le muestran para que escoja.

<b>Condición:</b> Los casos de salto incondicionales no tienen condición configurable. En los demás casos, los valores dependen del tipo de caso.

<b>Ir a:</b> El siguiente nodo donde ir si la condición se satisface. Debe ser uno de los nodos en este Cuestionario Adaptativo y puede ser el mismo nodo.
';
$string['end'] = 'Fin';
$string['endadaquiz'] = 'Fin del Cuestionario adaptativo';
$string['feedback']='Retroaalimentación';
$string['finish'] = 'Acabar';
$string['finishreview'] = 'Acabar revisión';
$string['finish_adaquiz'] = 'Finalizar';
$string['goto']='Ir a';
$string['gotonode'] = 'Ir al nodo';
$string['grade'] = 'Nota';
$string['gradedappempthighlighted'] = 'El intento evaluado para cada usuario está resaltado';
$string['iflastquestiongrade'] = 'Si la última nota';
$string['info'] = 'Info';
$string['introduction'] = 'Introducción';
$string['jump'] = 'Salto';
$string['jumptoquestion'] = 'Salta a otra pregunta:';
$string['last_grade'] = 'Última nota';
$string['letstudentdecidejump'] = 'Permite al estudiante decidir el salto';
$string['maximumgrade'] = 'Nota máxima:';
$string['modulename'] = 'Cuestionario adaptativo';
$string['modulenameplural'] = 'Cuestionarios adaptativos';
$string['noadaquizzes'] = 'No hay Cuestionarios adaptativos en este curso';
$string['noattempts'] = 'Aún no hay intentos.';
$string['nodeoptions'] = 'Opciones de nodo';
$string['nodes'] = 'Nodos';
$string['nodesinthisadaquiz'] = 'Nodos en este Cuestionario adaptativo';
$string['nonodes'] = 'Aún no se han añadido nodos';
$string['nonodesonquiz'] = 'Aún no se han añadido nodos';
$string['notyetcompleted'] = 'Aún no completado';
$string['order'] = 'Orden';
$string['outofamaximumof'] = 'sobre';
$string['preview'] = 'Previsualizar';
$string['question'] = 'Pregunta';
$string['reattempt'] = 'Re-intenta';
...
$string['reportusersall'] = 'todos los usuarios que han intentado el cuestionario adaptativo';
$string['reportuserswith'] = 'usuarios inscritos que han intentado el cuestionario adaptativo';
$string['reportuserswithorwithout'] = 'usuarios inscritos que han intentado, o no, el cuestionario adaptativo';
$string['reportuserswithout'] = 'usuarios inscritos que no han intentado el cuestionario adaptativo';
$string['reportwhattoinclude'] = 'Qué incluir en el informe';
$string['resetadaquizall'] = 'Reinicia todos los Cuestionarios adaptativos';
$string['results'] = 'Resultados';
$string['review'] = 'Revisión';
$string['reviewafterquestion']='Revisión tras una pregunta';
$string['reviewafterquiz']='Revisión tras el cuestionario';
$string['reviewofattempt'] = 'Revisión del intento';
$string['reviewofpreview'] = 'Revisión de la previsualización';
$string['savechanges'] = 'Guardar cambios';
$string['score']='Puntuación';
$string['showreport'] = 'Mostrar el informe';
$string['startagain'] = 'Empieza de nuevo';
$string['timefinished'] = 'Momento acabado';
$string['timestarted'] = 'Momento empezado';
$string['timetaken'] = 'Tiempo transcurrido';
$string['tonode'] = 'al nodo';
$string['type'] = 'Tipo';
$string['unconditional'] = 'Incondicional';
$string['unfinished'] = 'No acabado';
$string['useranswer'] = 'Respuesta del estudiante';
...
$string['modulename'] = 'Cuestionario adaptativo';
$string['modulename_help'] = 'La actividad Cuestionario Adaptativo permite al profesor ordenar preguntas en recorridos dinámicos que dependen de las respuestas del alumno. El resultado es un cuestionario que se adapta al rendimiento del alumno. Técnicamente, es un grafo dirigido donde los nodos son preguntas, y las aristas son saltos activados por rangos de nota.

El estudiante responde una pregunta, que se califica automáticamente, y entonces la nota determina la siguiente pregunta.
Habitualmente, si la respuesta fué incorrecta la siguiente pregunta será más fácil, y si la respuesta fué correcta la siguiente pregunta será más difícil, y así sucesivamente.

Aparte de esto, es como un cuestionario común de Moodle.
El profesor puede usar cualquier tipo de pregunta, y configurar los ajustes habituales de cuestionario sobre pistas y retroalimentación.';
